...
{
    public class SampleEventNodesNora : NodeBase
    {
        ...
        public OpcDataVariableNode<uint> Severity01;
        public OpcDataVariableNode<uint> Severity02;
        public OpcDataVariableNode<uint> Severity03;
        public OpcDataVariableNode<uint> Severity04;
        public OpcDataVariableNode<uint> Severity05;
        public OpcDataVariableNode<uint> Severity06;
        public OpcDataVariableNode<uint> Severity07;
        public OpcDataVariableNode<uint> Severity08;
        public OpcDataVariableNode<uint> Severity09;
        public OpcDataVariableNode<uint> Severity10;
        public OpcDataVariableNode<uint> Severity11;
        public OpcDataVariableNode<uint> Severity12;
        public OpcDataVariableNode<uint> Severity13;
        public OpcDataVariableNode<uint> Severity14;
        public OpcDataVariableNode<uint> Severity15;
        public OpcDataVariableNode<uint> Severity16;

        private readonly OpcFolderNode eventsFolder;
        private readonly List<IOpcNode> nodes = new List<IOpcNode>();

        public SampleEventNodesNora(OpcFolderNode parentFolder)
        {
        ...
        private void GetNodes()
        {
            ...
            Severity01 = CreateOpcUaNode<uint>(eventsFolder, "Severity01", nodes);
            Severity02 = CreateOpcUaNode<uint>(eventsFolder, "Severity02", nodes);
            Severity03 = CreateOpcUaNode<uint>(eventsFolder, "Severity03", nodes);
            Severity04 = CreateOpcUaNode<uint>(eventsFolder, "Severity04", nodes);
            Severity05 = CreateOpcUaNode<uint>(eventsFolder, "Severity05", nodes);
            Severity06 = CreateOpcUaNode<uint>(eventsFolder, "Severity06", nodes);
            Severity07 = CreateOpcUaNode<uint>(eventsFolder, "Severity07", nodes);
            Severity08 = CreateOpcUaNode<uint>(eventsFolder, "Severity08", nodes);
            Severity09 = CreateOpcUaNode<uint>(eventsFolder, "Severity09", nodes);
            Severity10 = CreateOpcUaNode<uint>(eventsFolder, "Severity10", nodes);
            Severity11 = CreateOpcUaNode<uint>(eventsFolder, "Severity11", nodes);
            Severity12 = CreateOpcUaNode<uint>(eventsFolder, "Severity12", nodes);
            Severity13 = CreateOpcUaNode<uint>(eventsFolder, "Severity13", nodes);
            Severity14 = CreateOpcUaNode<uint>(eventsFolder, "Severity14", nodes);
            Severity15 = CreateOpcUaNode<uint>(eventsFolder, "Severity15", nodes);
            Severity16 = CreateOpcUaNode<uint>(eventsFolder, "Severity16", nodes);
